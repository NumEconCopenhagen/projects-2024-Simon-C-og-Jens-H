...
class OLG_model:
    ...
    def plot_steady_state_payg_interactive(self, tau):
    ...
    def plot_interactive(self):
        interact(self.plot_steady_state_payg_interactive, tau=FloatSlider(min=0.0, max=1, step=0.1, value=0.4))
    ...
    def plot_interactive_tau_and_n(self):
        interact(self.plot_steady_state_payg_interactive_n, tau=FloatSlider(min=0.0, max=1, step=0.1, value=0.4), n=FloatSlider(min=-0.1, max=0.1, step=0.01, value=0.04))
